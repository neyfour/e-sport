...
export default function SuperAdminNavbar({ onMenuButtonClick }: SuperAdminNavbarProps) {
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                ...
                <span className="hidden sm:inline">{user?.username || user?.full_name || "Admin"}</span>
              </button>
